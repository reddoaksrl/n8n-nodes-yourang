...
const isPrepublish = process.env.ESLINT_PREPUBLISH === 'true';
...
module.exports = [
	...
	// Configuration for package.json
	{
		...
		rules: {
			...
			'n8n-nodes-base/community-package-json-name-still-default': isPrepublish ? 'error' : 'off',
		},
	},
	// Configuration for TypeScript credential files
	{
	...
	// Configuration for TypeScript node files
	{
		files: ['nodes/**/*.ts'],
		languageOptions: {
			parser: tsParser,
